...
function shuffleArray1(array) {
    ...
    // It should stay in place in 90% of cases.
    let shouldShuffleCorrectAnswer = Math.random() >= 0.3;
...
function generateQuizzes(allQuestions) {
    const numberOfQuizzes = 12;
    const questionsPerQuiz = 3; // Liczba pytań na quiz
